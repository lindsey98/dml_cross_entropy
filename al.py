...
def al_loop(args) -> None:
    ...
    for it in range(1, args.al_iter+1):
        ...
        logger.info("Current AL iteration {}, Number of unlabelled samples been queried {}, Current Training size {} | Pool size {} | Test size {}, Number of distinct classes in gallery/training set {}".format(it, sampled_size, training_size, 
        ...
        # extract features
        all_pool_features, all_pool_labels, all_pool_samples = feature_extractor(model=cur_model, 
        ...
        print("Total # of instances selected = {}, # selected FNs at current iteration = {} out of total {} FNs, # selected FPs at current iteration = {} out of total {} FPs".format(len(selected_samples), 
